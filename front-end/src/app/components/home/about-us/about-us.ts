...
export class AboutUs implements OnInit {
  ...
  private fallbackImages = [
    //Esquerda superior
    {
      desktop: 'https://picsum.photos/450/315.webp?random=1',
      mobile: 'https://picsum.photos/320/166.webp?random=2',
      altText: ''
    },
    //Esquerda inferior
    {
      desktop: 'https://picsum.photos/450/315.webp?random=3',
      mobile: 'https://picsum.photos/320/166.webp?random=4',
      altText: ''
    },
    //Direita vertical
    {
      desktop: 'https://picsum.photos/450/638.webp?random=5',
      mobile: 'https://picsum.photos/320/351.webp?random=6',
      altText: ''
    },
    //Inferior horizontal
    {
      desktop: 'https://picsum.photos/900/500.webp?random=7',
      mobile: 'https://picsum.photos/700/203.webp?random=8',
      altText: ''
    }
  ];
