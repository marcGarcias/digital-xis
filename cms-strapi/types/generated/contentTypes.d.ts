...
export interface ApiCarrocelCarrocel extends Struct.SingleTypeSchema {
  collectionName: 'carrocels';
  info: {
    displayName: 'Carrocel';
    pluralName: 'carrocels';
    singularName: 'carrocel';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Imagens_Desktop: Schema.Attribute.Media<'images', true>;
    Imagens_Mobile: Schema.Attribute.Media<'images', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::carrocel.carrocel'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiInfoInfo extends Struct.SingleTypeSchema {
  ...
  attributes: {
    Ano_do_Copyrights: Schema.Attribute.BigInteger;
...
export interface ApiSobreSobre extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    imagem_direita_Desktop: Schema.Attribute.Media<'images'>;
    imagem_direita_Mobile: Schema.Attribute.Media<'images'>;
    imagem_inferior_Desktop: Schema.Attribute.Media<'images'>;
    imagem_inferior_esquerda_Desktop: Schema.Attribute.Media<'images'>;
    imagem_inferior_esquerda_Mobile: Schema.Attribute.Media<'images'>;
    imagem_inferior_Mobile: Schema.Attribute.Media<'images'>;
    imagem_superior_esquerda_Desktop: Schema.Attribute.Media<'images'>;
    imagem_superior_esquerda_Mobile: Schema.Attribute.Media<'images'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::carrocel.carrocel': ApiCarrocelCarrocel;
